...
export const cancerTypes: CancerType[] = [
  ...
  },
  {
    ...
    overviewHtml:
      "Rare cancers collectively account for over 20% of all cancer diagnoses, yet patients often face diagnostic delays and limited treatment options. Our dedicated rare cancers program brings together a multidisciplinary tumour board, molecular profiling capabilities, and access to basket trials that match patients to therapies based on molecular alterations rather than tumour site. We collaborate with international rare cancer consortia to pool data and accelerate research.",
    impactStats: [
      { label: "Rare cancer cases reviewed annually", value: "600+" },
      { label: "Molecular profiling rate", value: "91%" },
      { label: "International consortium partnerships", value: "7" },
      { label: "Basket trial enrolments", value: "85" },
    ],
    researchThemes: [
      {
        title: "Molecular Tumour Board",
        description:
          "Comprehensive genomic profiling and expert review to identify actionable alterations in rare and unusual tumour types.",
      },
      {
        title: "Neuroendocrine Tumour Research",
        description:
          "Peptide receptor radionuclide therapy optimisation and somatostatin receptor–targeted imaging studies.",
      },
      {
        title: "Cancer of Unknown Primary",
        description:
          "Gene expression profiling to identify tissue of origin and guide site-specific therapy in CUP patients.",
      },
      {
        title: "International Data Sharing",
        description:
          "Contributing to global rare cancer registries and federated learning networks to overcome small sample size limitations.",
      },
    ],
    clinicalTrials: [
      {
        title: "Tissue-Agnostic Basket Trial for NTRK/ROS1/RET Fusion-Positive Rare Cancers",
        status: "Recruiting",
        pi: "Dr. T. Rajkumar",
        id: "NCT06234519",
      },
      {
        title: "Lu-177 DOTATATE in Advanced Neuroendocrine Tumours",
        status: "Active",
        pi: "Dr. R. Swaminathan",
        id: "NCT06234520",
      },
    ...
    donationUrl: "#donate",
    donationCta: "Support Rare Cancer Research",
    donationDescription:
      "Donations help patients with rare cancers access advanced molecular diagnostics and precision therapies through our dedicated multidisciplinary program.",
  },
];
