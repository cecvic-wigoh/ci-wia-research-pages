...
export const people: Person[] = [
  ...
  // International Adjunct Faculty
  {
    slug: "dr-james-chen",
    name: "Dr. James Chen",
    title: "Adjunct Professor, Molecular Oncology",
    department: "Department of Molecular Oncology",
    departmentSlug: "molecular-oncology",
    category: "adjunct",
    cancerTypes: ["colon-cancer", "gastric-cancer"],
    researchFocus:
      "Gut microbiome and colorectal cancer, international CRC microbiome consortium leadership",
    initials: "JC",
    researchInterests: [
      "Gut Microbiome",
      "Colorectal Cancer",
  ...
  },
  {
    ...
    title: "Adjunct Professor, Cancer Biology",
    department: "Department of Cancer Biology & Molecular Diagnostics",
    departmentSlug: "cancer-biology-molecular-diagnostics",
    category: "adjunct",
    cancerTypes: ["breast-cancer", "ovarian-womens-cancers"],
    researchFocus:
      "Epigenetic regulation of breast cancer, DNA damage response pathways, and PARP inhibitor resistance",
    initials: "SM",
    researchInterests: [
      "Epigenetics",
      "DNA Damage Response",
  ...
  },
  {
    ...
    title: "Adjunct Professor, Clinical Trials",
    department: "Clinical Trials & Statistical Unit",
    departmentSlug: "clinical-trials-statistical-unit",
    category: "adjunct",
    cancerTypes: ["blood-cancers", "childrens-cancers"],
    researchFocus:
      "CAR-T cell therapy manufacturing, affordable immunotherapy for low- and middle-income countries",
    initials: "DO",
    researchInterests: [
      "CAR-T Therapy",
      "Immunotherapy",
  ...
  },
  {
    slug: "dr-priya-nair",
    name: "Dr. Priya Nair",
    title: "Adjunct Professor, Preventive Oncology",
    department: "Department of Preventive Oncology",
    departmentSlug: "preventive-oncology",
    category: "adjunct",
    cancerTypes: ["head-and-neck-cancer", "lung-cancer"],
    researchFocus:
      "AI-driven cancer screening, computational pathology, and population-level cancer prevention strategies",
    initials: "PN",
    researchInterests: [
      "AI in Oncology",
      "Cancer Screening",
  ...
  {
    slug: "dr-michael-hartmann",
    name: "Dr. Michael Hartmann",
    title: "Adjunct Professor, Cancer Epidemiology",
    department: "Department of Cancer Epidemiology",
    departmentSlug: "cancer-epidemiology",
    category: "adjunct",
    cancerTypes: ["gastric-cancer", "colon-cancer"],
    researchFocus:
      "Population-based cancer registries, global cancer burden estimation, and H. pylori eradication trials",
    initials: "MH",
    researchInterests: [
      "Cancer Epidemiology",
  ...
  },
  {
    ...
    departmentSlug: "molecular-oncology",
    category: "adjunct",
    cancerTypes: ["breast-cancer", "bone-cancers"],
    researchFocus:
      "Liquid biopsy development, circulating tumour DNA assays, and minimal residual disease monitoring",
    initials: "AS",
    researchInterests: [
      "Liquid Biopsy",
      "ctDNA",
